...
const Card = ({ url, title, desc }) => {
  return (
    <>
      <a href="#">
        <div className="card card-animation hover:-translate-y-3 bg-base-200 w-[12rem] md:w-[14rem] lg:w-[16rem] shadow-xl transition-all duration-500 ease-in-out">
          ...
          <div className="card-body items-center text-center">
            ...
            <p className="card-subtitle text-sm md:text-base lg:text-lg">
              {desc.length > 50 ? `${desc.slice(0, 20)}...` : desc}
            </p>
          </div>
        </div>
      </a>
